...
<nav class="navbar navbar-light navbar-expand-lg fixed-top bg-primary" style="padding:0">
  <div class="container">
	    <a class="navbar-brand js-scroll-trigger text-white" href="./"><b>Welcome</b></a>
	        ...
	        <ul class="navbar-nav ml-auto my-2 my-lg-0">
	            ...
	            <li class=" dropdown nav-item">
	              ...
	              <div class="dropdown-menu" aria-labelledby="account_settings" style="left: -2.5em;">
	                <a class="dropdown-item" href="index.php?page=signup&id=<?php echo $_SESSION['login_id'] ?>" id=""><i class="fa fa-cog"></i>  Account</a>
